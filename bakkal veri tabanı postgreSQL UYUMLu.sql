CREATE DATABASE market_db; [cite: 1]

-- Tablolar [cite: 1, 2, 3, 4]
...
-- 1. Yeni bir satış yapıldığında stoktan düşer [cite: 7, 8, 9]
...
-- 2. Bir satış iptal edildiğinde stoka geri ekler [cite: 9, 10, 11]
...
-- 3. Ürün stoğu eksi değere düşmesini engeller [cite: 11, 12, 13]
...
-- 4. Ürün eklerken fiyatın eksi girilmesini engeller [cite: 13, 14, 15]
...
-- 5. Ürün adı boş bırakılırsa 'Bilinmeyen' atar [cite: 15, 16, 17]
...
-- 6. Yeni satış girilirken adet en az 1 olarak ayarlanır [cite: 17, 18, 19]
...
-- 7. Fiyat güncellenirken yanlışlıkla 0 veya eksi girilirse eski fiyatı korur [cite: 19, 20, 21]
...
-- 8. Yeni ürün eklenirken başlangıç stoğunun eksi girilmesini engeller [cite: 21, 22, 23]
...
-- 9. Satış adedi güncellenirken 1'den küçük girilirse eski adedi korur [cite: 23, 24, 25]
...
-- 10. Tek seferde çok büyük miktarda satış girilmesini engeller (Sınır 100) [cite: 25, 26, 27]
